# 1 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c"
...
# 2 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 3 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 4 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic.h"
int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs);
int backtrace_now_app(int (*print_func)(const char *fmt, ...));
# 5 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c" 2

int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs) __attribute__ ((weak, alias ("backtrace_riscv")));
# 163 "/home/sp/repos/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic_c.c"
